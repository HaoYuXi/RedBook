...
public class ImagePickAndCropActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_shootVideo).setOnClickListener(this);
        findViewById(R.id.tv_takeAlbum).setOnClickListener(this);
        ...
        mShootVideoFragment = new ShootVideoFragment();
    }
    ...
    private void initView() {
        ...
        mAlbumFragment = new ImagePickAndCropFragment();
        mAlbumFragment.setArguments(bundle);
        mAlbumFragment.setImageListener(new OnImagePickCompleteListener() {
            @Override
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, mAlbumFragment)
                .commit();
    }

    @Override
    public void onBackPressed() {
        if (null != mAlbumFragment && mAlbumFragment.onBackPressed()) {
            return;
        }
        super.onBackPressed();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (mAlbumFragment != null) {
            mAlbumFragment.onTakePhotoResult(requestCode, resultCode);
        }
    }
...
//            }
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container, mShootVideoFragment)
                    .commit();
        } else if (id == R.id.tv_takePhoto) {

            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container, mTakePhotoFragment)
                    .commit();
